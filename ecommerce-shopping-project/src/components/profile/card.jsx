    ...
    return (
        <>
            <div className="container">
                <div className="row">
                    <div className="col-sm-3 card " style={{width:"18rem" , marginRight:"25px", marginLeft:"30px"}} onClick={() => {
                        navigate("/product")
                    }}>
                        <h2 class="card-text"> All Products</h2>
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQl8BZnNsKXeWOytU1mut-nSbiAH64QGerudw&usqp=CAU" alt="family" />
                    </div>
                    
                    <div className="col-sm-3 card" style={{width:"18rem" , marginRight:"25px"}} onClick={() => {
                        navigate("/menswear")
                    }} >
                        <h2 > Men's Wear</h2>
